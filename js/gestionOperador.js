/*document.addEventListener('DOMContentLoaded', () => {
    ...
    const ordenesOperador = ordenes.filter(orden => orden.operador === operadorNombre);
    ...
    ordenesOperador.forEach(orden => {
        ...
        card.dataset.ordenId = orden.idOrden; // Establecer el ID de la orden en el dataset
        ...
        card.innerHTML = `
            ...
            <div class="mb-3">
                <textarea class="form-control comentario" rows="3" placeholder="Comentario..."></textarea>
            </div>
            <div class="card-body">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const operador = usuarios.find(usuario => usuario.idUsuario === usuarioLogueado);
    const operadorNombre = `${operador?.nombre} ${operador?.apellido}`;
    const ordenesOperador = ordenes.filter(orden => orden.operador === operadorNombre && orden.estado === 'asignada'); // Filtrar por operador y estado "asignada"
